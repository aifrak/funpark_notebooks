defmodule FunPark.Patron do
  ...
  # END:max_priority_monoid

  # START:highest_priority
  ...
  # START:max_priority_maybe_monoid
  ...
  # END:max_priority_maybe_monoid

  # START:highest_priority_maybe
  ...
  # END:remove_fast_pass

  # START:add_fast_pass_maybe
  ...
  # END:add_fast_pass_maybe

  # START:add_fast_pass_either
